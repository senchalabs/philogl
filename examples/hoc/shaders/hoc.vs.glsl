    ...
    void main(void) {
      ...
      float cIntensity = intensity / 120.0;
      vColor = vec4(cIntensity/1.2, cIntensity/1.2, cIntensity, 1.0);
//      vColor = vec4( (1.0 + sin(cIntensity)) / 2.0, (1.0 + sin(cIntensity)) / 2.0, (1.0 + cos(1.0 - cIntensity)) / 2.0, 1.0);
