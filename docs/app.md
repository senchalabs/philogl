--- 
layout: docs 
title: WebGLApplication 
categories: [Documentation]
---

Class: WebGLApplication {#WebGLApplication}
============================================

The WebGLApplication class has useful methods to manipulate
...
particular program. A WebGLApplication is created via the
...
the WebGLApplication or any other [Program](program.html) instance. This
...
WebGLApplication Method: setBuffer {#WebGLApplication:setBuffer}
-----------------------------------------------------------------
...
WebGLApplication Method: setBuffers {#WebGLApplication:setBuffers}
-------------------------------------------------------------------
...
WebGLApplication Method: setFrameBuffer {#WebGLApplication:setFrameBuffer}
---------------------------------------------------------------------------
...
WebGLApplication Method: setFrameBuffers {#WebGLApplication:setFrameBuffers}
-----------------------------------------------------------------------------
...
WebGLApplication Method: setRenderBuffer {#WebGLApplication:setRenderBuffer}
-----------------------------------------------------------------------------
...
WebGLApplication Method: setRenderBuffers {#WebGLApplication:setRenderBuffers}
--------------------------------------------------------------------------------
...
WebGLApplication Method: setTexture {#WebGLApplication:setTexture}
-------------------------------------------------------------------
...
WebGLApplication Method: setTextures {#WebGLApplication:setTextures}
-----------------------------------------------------------------------
...
WebGLApplication Method: use {#WebGLApplication:use}
-------------------------------------------------------------
