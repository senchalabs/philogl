...
### Syntax:
	...
	var program = Octant.Program.fromShaderURIs(options);
...
{% highlight js %}
var program = Octant.Program.fromShaderURIs({
  path: 'shaders/',
  vs: 'vertex.glsl',
  fs: 'fragment.glsl',
...
### Syntax:
	...
	var program = Octant.Program.fromShaderIds(vertexShaderId, fragmentShaderId);
...
{% highlight js %}
var program = Octant.Program.fromShaderIds('shader-vs', 'shader-fs');
{% endhighlight %}
...
### Syntax:
	...
	var program = Octant.Program.fromShaderIds(vertexShaderSource, fragmentShaderSource);
...
{% highlight js %}
var program = Octant.Program.fromShaderSources([
  "attribute vec3 aVertexPosition;",
...
Creates a new program by using the sources taken from [Shaders.Vertex](http://philogb.github.com/octant/doc/shaders.html#Shaders:Vertex) and 
[Shaders.Fragment](http://philogb.github.com/octant/doc/shaders.html#Shaders:Fragment).

### Syntax:

	var program = Octant.Program.fromShaderIds(vertexDefaultShaderId, fragmentDefaultShaderId);

### Arguments:

1. vertexDefaultShaderId - (*string*, optional) The vertex shader id from [Shaders.Vertex](http://philogb.github.com/octant/doc/shaders.html#Shaders:Vertex). Default's `Default`.
2. fragmentShaderSource - (*string*) The fragment shader id from [Shaders.Fragment](http://philogb.github.com/octant/doc/shaders.html#Shaders:Fragment). Default's `Default`.

### Examples:

Extend [Shaders.Fragment](http://philogb.github.com/octant/doc/shaders.html#Shaders:Fragment) with a default shader and create a Program from defaults. 
Taken from [lesson 8](http://philogb.github.com/octant/Octant/examples/lessons/8/) example.
...
var program = Octant.Program.fromDefaultShaders('Default', 'Blend');
...
The context of this example can be seen [here](http://philogb.github.com/octant/Octant/examples/lessons/3/).
